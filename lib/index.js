...
/**
 * Configures Passport-based user authentication and sessions.
 *
 * @private
 * @param {express~Application} app - The app to configure.
 ...
 */
function configAuth(app, sequelize, cookieSecret) {
    app.use(session({
        cookie: {
            httpOnly: false,
...
async function serve(config) {
    ...
    configAuth(app, sequelize, cookieSecret);
