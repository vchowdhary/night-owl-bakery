 ...
 * @private
 */
const ProfileAttrs = Object.freeze(
    /** @lends module:Users#Profile# */ {
        /**
         * User ID.
         *
         * @type {string}
         ...
         */
        likert: { type: Sequelize.JSON, allowNull: false },

        /**
         * Semantic differential scale question responses.
         *
         * @type {Object.<string, number>}
         */
        semDiff: { type: Sequelize.JSON, allowNull: false },
         ...
         */
        openResp: { type: Sequelize.JSON, allowNull: false }
    }
);
